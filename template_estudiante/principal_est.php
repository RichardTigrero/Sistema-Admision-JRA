...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="principal_est.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="principal_est.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class=" container-fluidr">
                    <img class="d-flex justify-content-center align-item-center" src="/imagenes/frases.webp" alt="frases" >
                </div>
                <!-- /.container-fluid -->

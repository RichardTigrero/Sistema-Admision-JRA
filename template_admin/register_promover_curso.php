            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="register_periodo_lectivo.php">Per&iacute;odos Lectivos</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo htmlspecialchars($_SESSION["nombres_admin"] ?? '', ENT_QUOTES, 'UTF-8'); ?></span>
    ...
    <script>
        ...
        async function procesarPromocion() {
            ...
            try {
                ...
                const response = await fetch('procesar_promocion_curso.php', { method: 'POST', body: formData });

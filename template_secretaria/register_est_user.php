        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-sm-6">
                    <form action="registra_estudiantes_masivos.php"  method="POST" target="_blank;width='400px';heigth='400px';" enctype="multipart/form-data">
                          
                        <label><b>Curso:</b></label>
                        <select class="form-control form-control-md" name="curso" id="curso">
                            <option value="0" >Seleccione curso</option>
                            <?php
                            //include("../conexion/conexion.php");
                            $sql = "SELECT id_jornada_curso, nombre_jornada_curso FROM jornada_curso where estado='ACTIVO'";
                         ...
                         <div class="form-group">
                              ...
                              <label for="exampleFormControlFile1"><b>Debe seleccionar un archivo en formato excel</b></label>

-- ============================================
-- SCRIPT COMPLETO DE CORRECCION DEL PROCEDIMIENTO
-- ============================================
-- Este script crea las tablas historicas necesarias y corrige el
-- procedimiento sp_procesar_periodo_lectivo para archivar estudiantes,
-- est_datos y jornada_curso, y luego reasignar los datos al periodo
-- que permanezca ACTIVO.

-- PASO 1: Agregar columna id_periodo_lectivo a jornada_curso (si no existe)
-- ALTER TABLE jornada_curso ADD COLUMN IF NOT EXISTS id_periodo_lectivo INT DEFAULT NULL AFTER estado;

-- PASO 2: Crear tabla historica de estudiantes
...
-- PASO 3: Crear tabla historica de est_datos
...
-- PASO 4: Crear tabla historica de jornada_curso
...
-- PASO 5: Eliminar el procedimiento anterior
DROP PROCEDURE IF EXISTS sp_procesar_periodo_lectivo;

-- PASO 6: Crear el procedimiento mejorado
DELIMITER //
...
sp_proc: BEGIN
    ...
    -- Obtener la descripcion del periodo que se va a cerrar
    SELECT descripcion
    ...
    -- Buscar el periodo que quedara ACTIVO despues del cierre
    ...
    -- 1. Crear tabla temporal para jornadas/cursos del periodo actual
    ...
    -- 2. Crear tabla temporal para estudiantes del periodo actual
    ...
    -- 3. Crear tabla temporal para datos_estudiantes del periodo actual
    ...
    -- 4. Insertar datos en tabla historial de jornada_curso
    ...
    -- 5. Insertar datos en tabla historial de estudiantes
    ...
    -- 6. Insertar datos en tabla historial de est_datos
    ...
    -- 7. Reasignar los datos al periodo que sigue ACTIVO
    UPDATE est_datos ed
    ...
    -- 8. Actualizar estado del periodo a CERRADO
...
-- 4. Copia ESTE CONTENIDO completo
-- 5. Pega en el area de SQL
-- 6. Haz clic en Ejecutar
--
-- Nota:
-- Para cerrar un periodo debe existir otro periodo en estado ACTIVO,
-- porque ese sera el destino para actualizar est_datos y jornada_curso.
-- ============================================
